...
exports.BaseCaptureProcessor = void 0;
...
class BaseCaptureProcessor {
     ...
     */
    constructor(name, description, supportedSourceTypes) {
        this.name = name;
        this.description = description;
        this.supportedSourceTypes = supportedSourceTypes;
        this.logger = new logger_1.Logger(`CaptureProcessor:${name}`);
    }
    /**
     * 获取处理器名称
     */
     ...
     * @param item 捕获项
     */
    async processImageContent(item) {
        // 子类应重写此方法以提供实际实现
     ...
     * @param item 捕获项
     */
    async processAudioContent(item) {
        // 子类应重写此方法以提供实际实现
     ...
     * @param item 捕获项
     */
    async processVideoContent(item) {
        // 子类应重写此方法以提供实际实现
     ...
     * @param item 捕获项
     */
    async processEmailContent(item) {
        // 子类应重写此方法以提供实际实现
     ...
     * @param item 捕获项
     */
    async processSocialContent(item) {
        // 子类应重写此方法以提供实际实现
     ...
     * @param item 捕获项
     */
    async processCustomContent(item) {
        // 子类应重写此方法以提供实际实现
     ...
     */
    getUnsupportedResult(contentType) {
        return {
            success: false,
...
exports.BaseCaptureProcessor = BaseCaptureProcessor;
//# sourceMappingURL=base-capture-processor.js.map